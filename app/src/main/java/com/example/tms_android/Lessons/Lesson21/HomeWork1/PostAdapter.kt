package com.example.tms_android.Lessons.Lesson21.HomeWork1
...
class PostAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            TYPE_AUTHOR -> AuthorViewHolder(inflater.inflate(R.layout.item_post_author, parent, false))
            TYPE_IMAGE -> ImageViewHolder(inflater.inflate(R.layout.item_post_image, parent, false))
            TYPE_BUTTON -> ButtonViewHolder(inflater.inflate(R.layout.item_post_button, parent, false))
