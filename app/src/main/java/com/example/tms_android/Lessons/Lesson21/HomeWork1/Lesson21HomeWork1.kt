...
import com.example.tms_android.databinding.ActivityLesson21Homework1Binding
import kotlin.random.Random

class Lesson21HomeWork1 : AppCompatActivity() {

    private lateinit var binding: ActivityLesson21Homework1Binding
    private val adapter = PostAdapter()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityLesson21Homework1Binding.inflate(layoutInflater)
